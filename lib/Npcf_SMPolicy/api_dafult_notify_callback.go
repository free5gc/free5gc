...
func (a *SMNotification) SMNotificationUri(ctx context.Context, smfNotifyUri string, request models.SmPolicyNotification) (*http.Response, error) {
	var (
...
func (a *SMNotification) SMTerminationUri(ctx context.Context, smfNotifyUri string, request models.TerminationNotification) (*http.Response, error) {
	var (
		localVarHTTPMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
