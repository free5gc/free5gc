...
func (a *SMFRegistrationApiService) SmfRegistrationsPduSessionId(ctx context.Context, ueId string, pduSessionId int32, smfRegistration models.SmfRegistration) (models.SmfRegistration, *http.Response, error) {
	...
	if pduSessionId < 0 {
		return localVarReturnValue, nil, common.ReportError("pduSessionId must be greater than 0")
	}
	if pduSessionId > 255 {
		return localVarReturnValue, nil, common.ReportError("pduSessionId must be less than 255")
	}
